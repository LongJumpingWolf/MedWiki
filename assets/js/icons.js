/*
 * Inline icon set (Lucide, ISC licence). Use <i data-icon="name"></i> in HTML,
 * or MedWiki.icon("name") when building markup in JS.
 */
...
(function () {
  ...
  MedWiki.icon = function (name, size) {
    var s = size || 24;
    return (
  ...
  MedWiki.hydrateIcons = function (root) {
    (root || document).querySelectorAll("i[data-icon]").forEach(function (el) {
      el.outerHTML = MedWiki.icon(el.getAttribute("data-icon"));
    });
  };
})();
